  ...
  return (
    <section className="pt-8">
      <div className="text-center">
        ...
        <p className="mt-3 text-xl text-gray-600">Frontend / Full-Stack Developer</p>
        <div className="mt-6 space-x-4">
          <a href="mailto:preritthakur2800@gmail.com" className="inline-block bg-indigo-600 text-white px-4 py-2 rounded">Email</a>
          <a href="https://discoversirmour.streamlit.app/" target="_blank" rel="noreferrer" className="inline-block border px-4 py-2 rounded">Website</a>
